...
.wrapper {
    display: grid;
    grid-gap: 2px;
    grid-template-columns: 225px 225px 225px 410pxx;
    grid-template-rows: 90px 90px 90px 160px;
...
::: wrapper
::: {.box .a}
```{r hotspots_dengue_torreon}
loc <- rgeomex::extract_locality(cve_edo = "05", 
                                 locality = "Torreon")
...
::: {.box .b}
```{r forest_plot_torreon, dpi = 300, fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_torreon,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
...
::: {.box .d}
```{r gauge_blocks_torreon,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
...
::: {.box .e}
```{r gauge_AGEB_torreon, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_torreon, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: {.box .b}
```{r forest_plot_acuña, dpi = 300, fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_acuña,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_acuña,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_acuña, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_acuña, out.height='90%', out.width = '90%', fig.align = "center"}
...
```{r vector_saltillo, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_05_coahuila,
                           locality = "Saltillo",
                           cve_edo = "05",
...
### [**Torreón**]{style="color:#990000"}
```{r vector_torreon, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_05_coahuila,
                           locality = "Torreon",
                           cve_edo = "05",
                           palette = rcartocolor::carto_pal,
...
```{r vector_monclova, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_05_coahuila,
                           locality = "Monclova",
                           cve_edo = "05",
                           palette = rcartocolor::carto_pal,
...
### [**Ciudad Acuña**]{style="color:#990000"}
```{r vector_acuña, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_05_coahuila,
                           locality = "Ciudad Acuña",
                           cve_edo = "05",
                           palette = rcartocolor::carto_pal,
...
### [**Torreón**]{style="color:#990000"}
```{r risk_ageb_torreon}
denhotspots::risk_ageb(betas = denmex::eggs_betas_05_coahuila,
